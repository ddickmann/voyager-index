...
- Native multi-vector index with GEM-paper-aligned algorithms (compliance matrix in `docs/research/GEM_COMPLIANCE_MATRIX.md`)
...
- Document health metric interpretation in `docs/guides/gem-native.md`
