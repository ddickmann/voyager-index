...
treated as internal compatibility paths, not the long-term OSS contract.
...
See `ADAPTER_CONTRACTS.md` for the intended documentation-level seams between
...
`src/kernels/vendor/qdrant/`. See `QDRANT_VENDORING.md` and
