"""
colsearch.Index — the primary public API for colsearch.
...
from colsearch._internal.public_index.builder import IndexBuilder
from colsearch._internal.public_index.factory import create_index_manager
from colsearch._internal.public_index.models import IndexStats, ScrollPage, SearchResult
...
class Index:
    """
    Primary interface for colsearch.
