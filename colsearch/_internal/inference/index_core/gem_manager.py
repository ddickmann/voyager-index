...
try:
    from colsearch._internal.kernels.kernel_warmup import _next_power_of_2, warmup_triton_kernels
...
try:
    from colsearch._internal.kernels.roq import roq_maxsim_4bit, ROQ_TRITON_AVAILABLE
