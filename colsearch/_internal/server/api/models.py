"""
Pydantic models for the colsearch reference API.
"""
...
class SearchRequest(BaseModel):
    ...
    graph_mode: GraphMode = Field(
        ...
        description=(
            ...
            "and 'force' requires the premium graph sidecar when available. Requires the optional colsearch[latence-graph] extra for the full premium lane."
        ),
    )
