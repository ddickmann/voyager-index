"""
Durable collection service for the colsearch reference API.
"""
...
from colsearch._internal.inference.config import IndexConfig
from colsearch._internal.inference.engines.colpali import ColPaliConfig, ColPaliEngine
from colsearch._internal.inference.index_core.graph_policy import LatenceGraphPolicy
...
from colsearch._internal.inference.shard_engine.capabilities import detect_runtime_capabilities
from colsearch._internal.inference.shard_engine.config import Compression, TransferMode
from colsearch._internal.inference.shard_engine.manager import ShardEngineConfig
from colsearch.transport import decode_payload
...
class SearchService:
    ...
    def _get_multimodal_optimizer_pipeline(self) -> Any:
        ...
        try:
            from colsearch._internal.inference.stateless_optimizer import GpuFulfilmentPipeline
    ...
    def _trim_multimodal_solver_items_to_payload(
        ...
        *,
        ...
        from colsearch._internal.inference.stateless_optimizer import optimizer_max_payload_bytes
    ...
    def reference_optimize(self, body: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Request/response shape matches :class:`~colsearch._internal.inference.stateless_optimizer.OptimizerRequest`
