"""
Multimodal model metadata and provider helpers for colsearch.
"""
    ...
    def pool(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            raise ImportError(
                "httpx is required for VllmPoolingProvider. Install colsearch[multimodal]."
            ) from exc
...
class VllmFactoryModernColBERTProvider:
    ...
    def _get_http_client(self):
        ...
        try:
            ...
            raise ImportError(
                "httpx is required for VllmFactoryModernColBERTProvider. Install colsearch[multimodal]."
            ) from exc
